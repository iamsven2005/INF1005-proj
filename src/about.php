...
<body>
    ...
    <main class="container py-5 text-white">
        <section class="text-center py-5">
            <p class="text-uppercase text-white mb-2">Our Story</p>
        ...
        <section class="row text-center gy-4 mb-5">
            <div class="col-md-4">
                <div class="card h-100 border-danger shadow-sm p-4 bg-dark text-white">
                    <div class="card-body">
                        <p class="text-white small mb-1">Curated Experiences</p>
                        <p class="display-6 mb-1"><?= number_format($stats['rooms']) ?></p>
                        <p class="text-white mb-0">rooms engineered with cinematic sets and collaborative puzzles.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 border-danger shadow-sm p-4 bg-dark text-white">
                    <div class="card-body">
                        <p class="text-white small mb-1">Bookings Logged</p>
                        <p class="display-6 mb-1"><?= number_format($stats['bookings']) ?></p>
                        <p class="text-white mb-0">secure reservations powered by the same back-end that drives availability.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100 border-danger shadow-sm p-4 bg-dark text-white">
                    <div class="card-body">
                        <p class="text-white small mb-1">Community Reviews</p>
                        <p class="display-6 mb-1"><?= number_format($stats['reviews']) ?></p>
                        <p class="text-white mb-0">averaging <?= htmlspecialchars($stats['avg_rating']) ?>/5 stars across every experience.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="services" class="row align-items-center gx-5 mb-5">
            ...
            <div class="col-lg-6">
                <div class="bg-dark text-white rounded-4 shadow-sm p-4 border border-danger">
        ...
        <section class="row gy-4">
            <article class="col-lg-6">
                <div class="border border-danger rounded-4 p-4 h-100 bg-dark text-white">
            ...
            <article class="col-lg-6">
                <div class="border border-danger rounded-4 p-4 h-100 bg-dark text-white">
                    ...
                    <a class="btn btn-outline-light" href="index.php#Rooms">See upcoming rooms</a>
                </div>
            </article>
        </section>
    </main>
